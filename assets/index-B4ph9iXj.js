...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Eo(e,t,n){let r=new Float32Array(fo),i=new G(0,1,0);return new Xi({name:`SphericalGaussianBlur`,defines:{n:fo,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:ko(),fragmentShader:`
	...
	`}var Ao=class extends Dt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new ri(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`,Cl={FOV:72,NEAR:1,FAR:9e3,CAMERA_HEIGHT:82,CAMERA_FOLLOW:.5,LOOK_AHEAD:900,LOOK_HEIGHT:30},wl={BASE_SPEED:520,FLUX_SPEED_MULTIPLIER:3600,ENERGY_SCALE:3.5},Tl={Z:220,HOVER:18,RADIUS:13,LENGTH:58},El={MAX:72,SIZE:44,HOVER:20,SPAWN_Z:2800,SPAWN_FADE:180,KILL_Z:-80,DOUBLE_SPAWN_FLUX:.25,INITIAL_COUNT:18,BASE_SPIN:.3,FLUX_SPIN_MULTIPLIER:6},Dl=3,Ol=Q.WIDTH/Dl,kl={BACKGROUND:new J(196874),CALM_RAIL:new J(52479),HOT_RAIL:new J(16720486),CALM_BASE:new J(660534),HOT_BASE:new J(3343886),CALM_SKY:new J(1127338),HOT_SKY:new J(14492228),SHIP:new J(15660799),SHIP_ACCENT:new J(56831),SHIP_CANOPY:new J(2250239)},Al=[new J(7812095),new J(2254591),new J(52394),new J(16759552),new J(16724821)];function jl(e){let t=Math.min(Math.max(e,0),1)*(Al.length-1),n=Math.min(Math.floor(t),Al.length-2);return Al[n].clone().lerp(Al[n+1],t-n)}var Ml=class{constructor(e){this.dummy=new rn,this.offset=0,this.flux=0,this.shipLane=1,this.renderer=e,this.camera=this.buildCamera(),this.scene=new pn,this.scene.background=kl.BACKGROUND;let{mesh:t,material:n}=this.buildTrack();this.trackMesh=t,this.trackMaterial=n,this.scene.add(this.trackMesh);let{mesh:r,material:i}=this.buildSky();this.skyMesh=r,this.skyMaterial=i,this.scene.add(this.skyMesh);let{mesh:a,material:o}=this.buildShip();this.shipMesh=a,this.shipMaterials=o,this.scene.add(this.shipMesh);let{mesh:s,material:c,states:l}=this.buildBlocks();this.blocksMesh=s,this.blockMaterial=c,this.blockStates=l,this.scene.add(this.blocksMesh),this.seedBlocks(),window.addEventListener(`resize`,()=>this.resize())}buildCamera(){let e=window.innerWidth/window.innerHeight,t=new Aa(Cl.FOV,e,Cl.NEAR,Cl.FAR);return t.position.set(0,Cl.CAMERA_HEIGHT,0),t.lookAt(new G(0,Cl.LOOK_HEIGHT,Cl.LOOK_AHEAD)),t}buildTrack(){let e=new zi(Q.WIDTH,Q.DEPTH,8,256);e.rotateX(-Math.PI/2),e.translate(0,0,Q.DEPTH/2);let t=new Xi({vertexShader:xl,fragmentShader:Sl,uniforms:{uOffset:{value:0},uFlux:{value:0},uEnergy:{value:0},uCalmRail:{value:kl.CALM_RAIL.clone()},uHotRail:{value:kl.HOT_RAIL.clone()},uCalmBase:{value:kl.CALM_BASE.clone()},uHotBase:{value:kl.HOT_BASE.clone()},uFogColor:{value:kl.BACKGROUND.clone()}}});return{mesh:new Y(e,t),material:t}}buildSky(){let e=new zi(9e3,3e3),t=new Xi({vertexShader:`
                varying vec2 vUv;
                void main() {
                    vUv = uv;
                    gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
...
`,Fl={WIDTH:3e3,DEPTH:5e3,SEGMENTS:128,FOV:60,NEAR:1,FAR:6e3,CAMERA_HEIGHT:60,LOOK_AHEAD:300,BASE_SPEED:0,FLUX_SPEED_MULTIPLIER:4e3,COLOR_COOLDOWN:0},Il={RADIUS:150,WIDTH_SEGMENTS:32,HEIGHT_SEGMENTS:16,DISTANCE:1800,HEIGHT:40},Ll={COUNT:5,WIDTH:4e3,HEIGHT:300,DISTANCE:1900,Y_OFFSET:100},Rl={WIDTH:4e3,HEIGHT:800,DISTANCE:1850,Y_OFFSET:140,CENTER_GAP:.25},zl={WIDTH:4e3,HEIGHT:800,DISTANCE:2200,Y_OFFSET:150},Bl=[{grid:new J(16711935),sun:new J(16737792)},{grid:new J(65535),sun:new J(16711782)},{grid:new J(16724889),sun:new J(16763904)},{grid:new J(6684927),sun:new J(16724736)},{grid:new J(65433),sun:new J(16737843)}],Vl=class{constructor(e){this.offset=0,this.currentPaletteIndex=0,this.renderer=e,this.camera=this.buildCamera(),this.scene=new pn,this.scene.background=new J(327688);let{mesh:t,material:n}=this.buildGrid();this.gridMesh=t,this.gridMaterial=n,this.scene.add(this.gridMesh);let{mesh:r,material:i}=this.buildSky();this.skyMesh=r,this.skyMaterial=i,this.scene.add(this.skyMesh),this.sunMesh=this.buildSun(),this.scene.add(this.sunMesh);let{mesh:a,material:o}=this.buildLasers();this.laserMesh=a,this.laserMaterial=o,this.scene.add(this.laserMesh);let{mesh:s,material:c}=this.buildBuildings();this.buildingsMesh=s,this.buildingsMaterial=c,this.scene.add(this.buildingsMesh),this.colorClock=new Ya,window.addEventListener(`resize`,()=>this.resize())}buildCamera(){let e=window.innerWidth/window.innerHeight,t=new Aa(Fl.FOV,e,Fl.NEAR,Fl.FAR);return t.position.set(0,Fl.CAMERA_HEIGHT,0),t.lookAt(new G(0,20,Fl.LOOK_AHEAD)),t}buildGrid(){let e=new zi(Fl.WIDTH,Fl.DEPTH,Fl.SEGMENTS,Fl.SEGMENTS);e.rotateX(-Math.PI/2);let t=Bl[0],n=new Xi({vertexShader:Nl,fragmentShader:Pl,uniforms:{uTime:{value:0},uFlux:{value:0},uOffset:{value:0},uGridColor:{value:t.grid.clone()}}}),r=new Y(e,n);return r.position.set(0,0,Fl.DEPTH*.5),{mesh:r,material:n}}buildSun(){let e=new Bi(Il.RADIUS,Il.WIDTH_SEGMENTS,Il.HEIGHT_SEGMENTS),t=Bl[0],n=new Y(e,new Xi({vertexShader:`
                uniform float uFlux;
                varying vec2 vUv;
                void main() {
                    vUv = uv;
            ...
            `,uniforms:{uGlowColor:{value:t.sun.clone()},uFlux:{value:0}},depthWrite:!1}),r=new Y(e,n);return r.position.set(0,zl.Y_OFFSET,zl.DISTANCE),{mesh:r,material:n}}buildBuildings(){let e=new zi(Rl.WIDTH,Rl.HEIGHT),t=Bl[0],n=new Xi({vertexShader:`
                varying vec2 vUv;
                void main() {
                    vUv = uv;
                    gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
            ...
            `,uniforms:{uEdgeColor:{value:t.grid.clone()},uFlux:{value:0},uCenterGap:{value:Rl.CENTER_GAP}},side:2}),r=new Y(e,n);return r.position.set(0,Rl.Y_OFFSET,Rl.DISTANCE),{mesh:r,material:n}}buildLasers(){let e=new zi(Ll.WIDTH,Ll.HEIGHT),t=Bl[0],n=new Xi({vertexShader:`
                varying vec2 vUv;
                void main() {
                    vUv = uv;
                    gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
